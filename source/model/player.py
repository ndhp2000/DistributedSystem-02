...
class Player:
    ...
    def get_bullet_target(self):
        ...
        if self._current_direction == STOP:
            return None
        direction = Maze.convert_player_direction_2_maze(self._current_direction)
    ...
    def shoot(self):
        ...
        bullet = Bullet(self._bullets_group, 0, self.position, target, self._current_direction)
